...
#include <fstream>
using namespace std;
void f(double *y, double *k1,double *k2,double *k3, double *k4,const double dx, double a, double b, double c);
  int main(void)
  {
  const double dx = 0.01;
  const double xmax = 100.0;
  double a = 10.0, b = 28.0, c = 8/3.0;
  double y[2];
  y[0] = 1; y[1] = 1; y[2] = 1;
...
void f(double *y, double *k1,double *k2,double *k3, double *k4, const double dt, double a, double b, double c)
{
  k1[0] = a*(y[1]-y[0]); //(y-x)*a
